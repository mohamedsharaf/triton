              ...
              <div class="row">
                <div class="col-sm-12 b-r">
                  <form id="form_1" role="form" action="#">
                    <input type="hidden" id="grupo_id" name="id" value=""/>
                    ...
                    <div class="form-group">
                      <label>Grupo</label>
                      <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre del grupo">
                    </div>
                  </form>
                </div>
              </div>
    ...
    function utilitarios(valor){
      switch(valor[0]){
        ...
        case 12:
          ...
          $('#modal_1_title').empty();
          $('#modal_1_title').append('Modificar grupo');
          $("#grupo_id").val(valor[1]);
        ...
        case 14:
          $('#modal_1_title').empty();
          $('#modal_1_title').append('Agregar nuevo grupo');
