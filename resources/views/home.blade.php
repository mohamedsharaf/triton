...
@section('js_plugins')
    <!-- Flot -->
        <script src="{{ asset('inspinia_v27/js/plugins/flot/jquery.flot.js') }}"></script>
        <script src="{{ asset('inspinia_v27/js/plugins/flot/jquery.flot.tooltip.min.js') }}"></script>
        <script src="{{ asset('inspinia_v27/js/plugins/flot/jquery.flot.spline.js') }}"></script>
        <script src="{{ asset('inspinia_v27/js/plugins/flot/jquery.flot.resize.js') }}"></script>
        <script src="{{ asset('inspinia_v27/js/plugins/flot/jquery.flot.pie.js') }}"></script>
        <script src="{{ asset('inspinia_v27/js/plugins/flot/jquery.flot.symbol.js') }}"></script>
        <script src="{{ asset('inspinia_v27/js/plugins/flot/jquery.flot.time.js') }}"></script>
    ...
    <!-- Sparkline -->
        <script src="{{ asset('inspinia_v27/js/plugins/sparkline/jquery.sparkline.min.js') }}"></script>
@endsection
