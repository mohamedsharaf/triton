                ...
                if($persona_id != '')
                {
                    ...
                    foreach ($query as $row)
                    {
                        ...
                        $respuesta['rows'][$i]['cell'] = array(
                            ...
                            $row["f_retorno"],
                            $row["n_dias"],
                            ($row["periodo"] == '')? '' : $this->periodo[$row["periodo"]],
        ...
        switch($tipo)
        {
            ...
            case '1':
                ...
                // === REGISTRAR MODIFICAR VALORES ===
                    if($opcion == 'n')
                    {
                        ...
                        $iu->codigo = str_pad((RrhhSalida::whereRaw("date_part('year', f_salida)='" . $anio . "'")->count())+1, 5, "0", STR_PAD_LEFT) . "/" . $anio;
            ...
            case '2':
                ...
                //=== OPERACION ===
                    ...
                    $data1['periodo']             = trim($request->input('periodo'));
                ...
                // === VALIDAR POR CAMPO ===
                    ...
                    if($data1['f_retorno'] >= $data1['f_salida'])
                    {
                        $respuesta['respuesta'] .= "La FECHA DE RETORNO debe de ser mayor o igual que la FECHA DE SALIDA.";
                        return json_encode($respuesta);
                    }
                    ...
                    $consulta3 = RrhhFthc::where('lugar_dependencia', '=', $consulta1['lugar_dependencia_funcionario'])
